...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-06-2016 a las 17:50:30
...
(17, 'Prueba', 'Esto es una prueba', 5, 'Accion', 'img10', 2016, 1);
...
--
ALTER TABLE `estrenos`
MODIFY `CodEstreno` int(3) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=6;
--
...
--
ALTER TABLE `visto`
MODIFY `CodigoVisto` int(3) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=8;
--

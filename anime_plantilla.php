				...
				<div class="col-xs-12">
					<div class="objeto row">
						...
						<span class="datos col-xs-9">
							...
							<span class="col-xs-12"><div class="bold">Año de finalización: </div><?php echo $anime[1] ?></span>
							<span class="col-xs-12"><div class="bold">Temporadas: </div><?php echo $anime[2] ?></span>
							<span class="col-xs-12"><div class="bold">Capitulos: </div><?php echo $anime[3] ?></span>
							<span class="col-xs-12"><div class="bold">Estudio: </div><?php echo $anime[4] ?></span>
							<?php
							if(!(empty($actores))){
								echo "<span class='col-xs-12'><div class='bold'>Dobladores: </div>";
					...
					<div class="row">
						<?php
							if(isset($_SESSION['usuario']))
							{
								...
								if($visto)
								{
									echo "<button id='vistos' class='btn btn-link visto'><i class='glyphicon glyphicon-ok'></i>Anime visto</button>";
								}
								else
								{
									echo "<button id='vistos' class='btn btn-link'><i class='glyphicon glyphicon-ok'></i>Marcar anime como visto</button>";
								}
								echo "<input type='hidden' id='tipo' value='anime'>";
					...
					<div class="episodios row">
						<div class='col-md-12 bold'>Lista de episodios:</div>
						<?php

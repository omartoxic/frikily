				...
				<div class="col-xs-12">
					<div class="objeto row">
						...
						<span class="datos col-xs-9">
							...
							<span class="col-xs-12"><div class="bold">Temporadas: </div><?php echo $series[2] ?></span>
							<span class="col-xs-12"><div class="bold">Capítulos: </div><?php echo $series[3] ?></span>
							<span class="col-xs-12"><div class="bold">Canal: </div><?php echo $series[4] ?></span>
							<?php
							if(!(empty($actores))){
								echo "<span class='col-xs-10'><div class='bold'>Actores: </div>";
					...
					<div class="row">
						<?php
							if(isset($_SESSION['usuario']))
							{
								...
								if($visto)
								{
									echo "<button id='vistos' class='btn btn-link visto'><i class='glyphicon glyphicon-ok'></i>Serie vista</button>";
								}
								else
								{
									echo "<button id='vistos' class='btn btn-link'><i class='glyphicon glyphicon-ok'></i>Marcar serie como vista</button>";
								}
								echo "<input type='hidden' id='tipo' value='serie'>";
